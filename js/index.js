$(document).ready(function() {
  ...
  $('#game div div').click(function(){
    ...
    $("#game div div").text("+");
    $("#game div div").removeClass('disable')
    $("#game div div").removeClass('o')
    $("#game div div").removeClass('x')
    $("#game div div").removeClass('btn-primary')
    $("#game div div").removeClass('btn-info')
     }
